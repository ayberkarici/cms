...
<div class="col-md-12 col-sm-12 col-xs-12">
    <h4 class="m-b-lg ">
        ...
        <a href="<?php echo base_url('references/new_form'); ?>" class=" btn btn-primary btn-outline btn-info btn-sm pull-right"><i class="fa fa-plus"></i> Yeni Ekle</a>
    </h4>
            ...
            <tr id="ord-<?php echo $item->id; ?>">
                ...
                <td>
                    <img 
                        ...
                        src="<?php echo get_picture($viewFolder, $image->img_url, "555x343"); ?>" 
                        alt="" 
                        srcset="">
                </td>
