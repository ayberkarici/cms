...
<div class="col-md-12 col-sm-12 col-xs-12">
    <h4 class="m-b-lg ">
        <span>Portfolio Kategori Listesi</span>
        <a href="<?php echo base_url('portfolio_categories/new_form'); ?>" class=" btn btn-primary btn-outline btn-info btn-sm pull-right"><i class="fa fa-plus"></i> Yeni Ekle</a>
    </h4>
    <div class="widget p-lg">
        ...
        <?php if(empty($items)) { ?>
            <div class="alert alert-info text-center" role="alert">
                ...
                <a href="<?php echo base_url('portfolio_categories/new_form'); ?>">tıklayınız</a>
            </div>        
            ...
            <tr>
                ...
                <td class="order-progress">
                    <a 
                        ...
                        href="<?php echo base_url("portfolio_categories/update_form/". $item->id) ?>">
