            ...
            <div class="widget-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6 ">
                        ...
                        <input class="form-control" placeholder="İşi anlatan başlık bilgisi" name="title" value="<?php echo (isset($form_error)) ? set_value("title") : "" ; ?>">
                    ...
                    <div class="row">
                        <div class="col-md-4">
							...
							<input type="hidden" name="finishedAt" id="datetimepicker1" data-plugin="datetimepicker" data-options="{ inline: true, viewMode: 'days', format:'YYYY-MM-DD HH:mm:ss' }" value="<?php echo (isset($form_error)) ? set_value("finishedAt") : "" ; ?>">
                        </div>
                        <div class="col-md-8">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group ">
                                        <label>Müşteri</label>
                                        <input class="form-control" placeholder="İşi yaptığınız müşteri" name="client" value="<?php echo (isset($form_error)) ? set_value("client") : "" ; ?>">
                                        <?php if(isset($form_error)): ?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group ">
                                        ...
                                        <input class="form-control" placeholder="İşi yaptığınız yer, mekan bilgisi" name="place" value="<?php echo (isset($form_error)) ? set_value("place") : "" ; ?>">
                                        <?php if(isset($form_error)): ?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group ">
                                        ...
                                        <input class="form-control" placeholder="Yapılan işin internet üzerindeki bağlantısı" name="portfolio_url" value="<?php echo (isset($form_error)) ? set_value("portfolio_url") : "" ; ?>">
                                        <?php if(isset($form_error)): ?>
