...
<div class="row">
    <div class="form-group col-md-8">
        ...
        <input class="form-control" placeholder="Şirketinizin e-posta adresi" name="email" value="<?php echo (isset($form_error)) ? set_value("email") : $item->email ;  ?>">
...
<div class="row">
    <div class="form-group col-md-4">
        ...
        <input class="form-control" placeholder="İnstagram adresiniz" name="instagram" value="<?php echo (isset($form_error)) ? set_value("instagram") : $item->instagram ;  ?>">
