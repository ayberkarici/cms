<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg ">
            <span>Yeni E=posta Hesabi Ekle</span>
        </h4>
    </div>
            ...
            <div class="widget-body">
                <form action="<?php echo base_url("emailsettings/save"); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control" placeholder="Host adı" name="host" value="<?php echo (isset($form_error)) ? set_value("host") : "" ;  ?>">
                        <?php if(isset($form_error)): ?>
                    ...
                    <div class="form-group ">
                        ...
                        <input type="password" class="form-control" placeholder="E-posta Adresine Ait Şifre" name="password" value="<?php echo (isset($form_error)) ? set_value("password") : "" ;  ?>">
                        <?php if(isset($form_error)): ?>
                    ...
                    <div class="form-group ">
                        ...
                        <input type="email" class="form-control" placeholder="E-posta adresi (Gönderen)" name="from" value="<?php echo (isset($form_error)) ? set_value("from") : "" ;  ?>">
                        <?php if(isset($form_error)): ?>
                    ...
                    <div class="form-group ">
                        ...
                        <input type="email" class="form-control" placeholder="E-posta adresi (Alan)" name="to" value="<?php echo (isset($form_error)) ? set_value("to") : "" ;  ?>">
                        <?php if(isset($form_error)): ?>
