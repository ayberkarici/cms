...
<div class="col-md-12 col-sm-12 col-xs-12">
    <h4 class="m-b-lg ">
        <span>Markalar</span>
        <a href="<?php echo base_url('brands/new_form'); ?>" class=" btn btn-primary btn-outline btn-info btn-xs pull-right"><i class="fa fa-plus"></i> Yeni Ekle</a>
    </h4>
    <div class="widget p-lg">
        ...
        <?php if(empty($items)) { ?>
            <div class="alert alert-info text-center" role="alert">
                ...
                <a href="<?php echo base_url('brands/new_form'); ?>">tıklayınız</a>
            </div>        
            ...
            <tr id="ord-<?php echo $item->id; ?>">
                ...
                <td class="order-progress">
                    <a 
                        ...
                        href="<?php echo base_url("brands/update_form/". $item->id) ?>">
