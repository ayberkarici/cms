                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="footer-content">
                            ...
                            <p>
                                    <?php echo character_limiter(strip_tags($settings->about_us), 100); ?>
                                <a href="<?php echo base_url("hakkimizda"); ?>">
                                    <i class="fa fa-long-arrow-right pl-1"></i>
                                </a>
                            </p>
                            ...
                            <nav>
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="<?php echo base_url("hakkimizda"); ?>">About</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="footer-content">
                            ...
                            <div class="text-right space-top">
                                <a href="blog-large-image-right-sidebar.html" class="link-dark"><i class="fa fa-plus-circle "></i> More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="footer-content">
                            ...
                            <div class="text-right space-top">
                                <a href="portfolio-grid-2-3-col.html" class="link-dark"><i class="fa fa-plus-circle "></i> More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
