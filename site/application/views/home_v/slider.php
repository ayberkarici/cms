                    ...
                    <li 
                        ...
                        <div class="tp-caption dark-translucent-bg caption-box text-left hidden-sm-down"
                            ...
                            <?php if($slide->allowButton){ ?>
                                <div class="text-right"><a target="_blank" class="btn btn-small btn-gray-transparent margin-clear" href="<?php echo $slide->button_url ?>"><?php echo $slide->button_caption ?></a></div>
                            <?php }; ?>
                        </div>
